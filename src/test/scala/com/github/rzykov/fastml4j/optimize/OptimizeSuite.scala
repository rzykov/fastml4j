package com.github.rzykov.fastml4j.optimize

/**
  * Created by rzykov on 25/06/17.
  */
import com.github.rzykov.fastml4j.loss.{LogisticLoss, OLSLoss}
import com.github.rzykov.fastml4j.optimizer.{GradientDescent, PegasosSGD}
